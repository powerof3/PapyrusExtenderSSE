...
namespace papyrusEffectShader
{
	...
	void SetMembraneColorKeyData(VM* a_vm, StackID a_stackID, RE::StaticFunctionTag*, RE::TESEffectShader* a_effectShader, std::uint32_t a_colorKey, std::vector<std::uint32_t> a_rgb, float a_alpha, float a_time);
	...
	void SetParticleColorKeyData(VM* a_vm, StackID a_stackID, RE::StaticFunctionTag*, RE::TESEffectShader* a_effectShader, std::uint32_t a_colorKey, std::vector<std::uint32_t> a_rgb, float a_alpha, float a_time);
