...
namespace papyrusGame
{
	...
	std::vector<RE::Actor*> GetActorsByProcessingLevel(VM* a_vm, StackID a_stackID, RE::StaticFunctionTag*, SInt32 a_level);
	...
	SInt32 GetNumActorsInHigh(VM* a_vm, StackID a_stackID, RE::StaticFunctionTag*);
