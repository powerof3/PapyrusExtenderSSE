...
namespace util::MAGIC
{
	...
	namespace detail
	{
		bool effect_is_match(RE::Effect* a_effect, RE::EffectSetting* a_mgef, float a_mag, std::uint32_t a_area, std::uint32_t a_dur, float a_cost)
		{
	...
	void MAGIC::add_effect_item(RE::MagicItem* a_item, RE::MagicItem* a_copyItem, std::uint32_t a_index, float a_cost)
	{
	...
	void MAGIC::remove_effect_item(RE::MagicItem* a_item, RE::MagicItem* a_copyItem, std::uint32_t a_index)
	{
		auto copyEffect = a_copyItem->effects[a_index];
