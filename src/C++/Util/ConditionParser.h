...
namespace util
{
	namespace CONDITION
	{
		...
		namespace MAP
		{
			inline constexpr frozen::map<std::uint32_t, std::string_view, 402> funcID = {
			...
			inline constexpr frozen::map<std::string_view, std::uint32_t, 402> funcID_reverse = {
			...
			inline constexpr frozen::map<std::uint32_t, std::string_view, 8> conditionObj = {
				{ 0, "Subject"sv },
				{ 1, "Target"sv },
				{ 2, "Reference"sv },
				{ 3, "Combat Target"sv },
			...
			inline constexpr frozen::map<std::string_view, std::uint32_t, 8> conditionObj_reverse = {
				{ "Subject"sv, 0 },
				{ "Target"sv, 1 },
				{ "Reference"sv, 2 },
				{ "Combat Target"sv, 3 },
			...
			inline constexpr frozen::map<std::uint32_t, std::string_view, 6> opCode = {
				{ 0, "=="sv },
				{ 1, "!="sv },
				{ 2, ">"sv },
				{ 3, ">="sv },
			...
			inline constexpr frozen::map<std::string_view, std::uint32_t, 6> opCode_reverse = {
				{ "=="sv, 0 },
				{ "!="sv, 1 },
				{ ">"sv, 2 },
				{ ">="sv, 3 },
