...
namespace Papyrus::Actor
{
	...
	std::vector<RE::TESQuest*>      GetActiveAssociatedQuests(STATIC_ARGS, RE::Actor* a_actor, bool a_allowEmptyStages); // SeaSparrow - New Functions
	std::vector<RE::TESQuest*>      GetAllAssociatedQuests(STATIC_ARGS, RE::Actor* a_actor, bool a_allowEmptyStages);    // SeaSparrow - New Functions
#ifdef SKYRIMVR
